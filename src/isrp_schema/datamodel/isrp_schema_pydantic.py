...
linkml_meta = LinkMLMeta({'default_prefix': 'isrp_schema',
     ...
     'prefixes': {'PATO': {'prefix_prefix': 'PATO',
                  ...
                  'isrp_schema': {'prefix_prefix': 'isrp_schema',
                                  'prefix_reference': 'https://w3id.org/haixia369/isrp-schema/'},
                  'linkml': {'prefix_prefix': 'linkml',
                             'prefix_reference': 'https://w3id.org/linkml/'},
                  'schema': {'prefix_prefix': 'schema',
                             'prefix_reference': 'http://schema.org/'}},
     'see_also': ['https://haixia369.github.io/isrp-schema'],
     'source_file': 'src/isrp_schema/schema/isrp_schema.yaml',
     'title': 'isrp-schema'} )
...
class NamedThing(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'schema:Thing',
         'from_schema': 'https://w3id.org/haixia369/isrp-schema'})
...
class Person(NamedThing):
    ...
    Represents a Person
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/haixia369/isrp-schema',
...
class PersonCollection(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/haixia369/isrp-schema', 'tree_root': True})
