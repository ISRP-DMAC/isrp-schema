# Contributing to isrp-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
isrp-schema. These guidelines are not strict rules.
...
The isrp-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the isrp-schema technical leads
...
[issues]: https://github.com/haixia369/isrp-schema/issues/
[pulls]: https://github.com/haixia369/isrp-schema/pulls/
